...
public class ScoringSystemLevel3 : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        GameObject.Find("Kale").GetComponent<kaleMovement>().width = GameObject.Find("Kale").GetComponent<kaleMovement>().width + 1F;
        GameObject.Find("Kale").GetComponent<kaleMovement>().height = GameObject.Find("Kale").GetComponent<kaleMovement>().height + 1F;
